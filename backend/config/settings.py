"""
Django settings for Feriearbete Platform.
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'feriearbete'),
        'USER': os.getenv('DB_USER', 'ferieadmin'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'feriepassword'),
        'HOST': os.getenv('DB_HOST', 'localhost'),
        'PORT': os.getenv('DB_PORT', '5433'),  # Using 5433 to avoid conflicts
    }
}
